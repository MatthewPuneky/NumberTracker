...
namespace NumberTracker.Core.Features.Categories
{
        ...
        : IRequestHandler<GetAllCategoriesRequest, List<CategoryGetDto>>
    {
        ...
        public async Task<List<CategoryGetDto>> Handle(
    ...
    public class GetAllCategoriesRequestValidator 
        : AbstractValidator<GetAllCategoriesRequest>
    {
